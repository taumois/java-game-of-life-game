...
class BorderedGrid implements Grid {
     ...
     * @param height height to make the grid
     */
    BorderedGrid(int width, int height) {
     ...
     * 
     */
    BorderedGrid(Cell[][] cells, int[] quantitiesOfNeighborsToAllowSurvival, int[] quantitesOfNeighborsToAllowReproduction) {
     ...
     * 
     */
    BorderedGrid(int[] quantitiesOfNeighborsToAllowSurvival, int[] quantitesOfNeighborsToAllowReproduction) {
        this.QUANTITY_OF_COLUMNS = DEFAULT_QUANTITY_OF_COLUMNS;
        this.QUANTITY_OF_ROWS = DEFAULT_QUANTITY_OF_ROWS;
